...
3. Now, the listing of Operands can be done which is picked from database. Please note: there may be unused items in JMS yet, but it will not fetch them.
4. Finally, a sum of GCDs can be invoked.

The application has been fully tested on Chrome browser.
If at all the application doesn't work, screenshots are captured in the word document named screenshots.docx
